...
export default function ViewOrders({ login, role, _id }) {
  ...
  return (
    <div class="col main pt-5 mt-5">
      ...
      <TableContainer component={Paper}>
        <Table>
          <TableHead>
            <TableRow style={{ backgroundColor: "#ef9a9a" }}>
              <TableCell align="center" className={classes.tableHeadCell}>Sr.No</TableCell>
              <TableCell align="center" className={classes.tableHeadCell}>Customer Name</TableCell>
